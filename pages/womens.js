          ...
          <>
            <div className="col-md-8">
              <div className="row mb-4" id="content" style={{display: "flex"}}>
                  {fakestore.map((store) => (
                <div className="col-md-4 my-4 justify-content-center text-center animation fade-in" style={{marginRight: "140px"}}>
                  <div className="bg-image hover-overlay hover-zoom hover-shadow ripple rounded">
                    <img src={store.image} className="img-fluid w-100" style={{height: "330px"}}></img>
                    <a href="#!">
